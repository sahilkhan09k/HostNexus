    ...
    <div className="grid w-full max-w-5xl grid-cols-1 overflow-hidden rounded-3xl border border-stone-200 bg-white shadow-[0_20px_60px_-10px_rgba(0,0,0,0.12)] lg:grid-cols-2">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Email */}
          <div>
            <label htmlFor="email" className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-stone-500">
              Business Email
            </label>
        ...
        <button
          type="button"
          className={cn(
            "flex w-full items-center justify-center gap-3 rounded-xl border border-stone-200 bg-white py-3 text-sm font-medium text-stone-700",
            "hover:border-stone-300 hover:bg-stone-50 transition-all duration-200"
          )}
        >
        ...
        <p className="mt-6 text-center text-xs text-stone-400">
          ...
          <Link href="#" className="underline hover:text-emerald-600 transition-colors">Terms</Link>
          {" "}and{" "}
          <Link href="#" className="underline hover:text-emerald-600 transition-colors">Privacy Policy</Link>.
        </p>
      </motion.div>
    </div>
  );
